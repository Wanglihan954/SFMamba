...
_CN.DATASET.TRAIN_IMAGE_ROOT = None
_CN.DATASET.TRAIN_DEPTH_ROOT = None
_CN.DATASET.TRAIN_IMAGE_PATH_PREFIX_TO_STRIP = ''
_CN.DATASET.TRAIN_DEPTH_PATH_PREFIX_TO_STRIP = ''
_CN.DATASET.VAL_DATA_ROOT = None
_CN.DATASET.VAL_POSE_ROOT = None  # (optional directory for poses)
_CN.DATASET.VAL_NPZ_ROOT = None
_CN.DATASET.VAL_LIST_PATH = None    # None if val data from all scenes are bundled into a single npz file
_CN.DATASET.VAL_INTRINSIC_PATH = None
_CN.DATASET.VAL_IMAGE_ROOT = None
_CN.DATASET.VAL_DEPTH_ROOT = None
_CN.DATASET.VAL_IMAGE_PATH_PREFIX_TO_STRIP = ''
_CN.DATASET.VAL_DEPTH_PATH_PREFIX_TO_STRIP = ''
# testing
...
_CN.DATASET.TEST_IMAGE_ROOT = None
_CN.DATASET.TEST_DEPTH_ROOT = None
_CN.DATASET.TEST_IMAGE_PATH_PREFIX_TO_STRIP = ''
_CN.DATASET.TEST_DEPTH_PATH_PREFIX_TO_STRIP = ''
