...
class MultiSceneDataModule(pl.LightningDataModule):
    ...
    def __init__(self, args, config):
        ...
        self.train_image_root = config.DATASET.TRAIN_IMAGE_ROOT
        self.train_depth_root = config.DATASET.TRAIN_DEPTH_ROOT
        self.train_image_path_prefix_to_strip = config.DATASET.TRAIN_IMAGE_PATH_PREFIX_TO_STRIP
        self.train_depth_path_prefix_to_strip = config.DATASET.TRAIN_DEPTH_PATH_PREFIX_TO_STRIP
        ...
        self.val_image_root = config.DATASET.VAL_IMAGE_ROOT
        self.val_depth_root = config.DATASET.VAL_DEPTH_ROOT
        self.val_image_path_prefix_to_strip = config.DATASET.VAL_IMAGE_PATH_PREFIX_TO_STRIP
        self.val_depth_path_prefix_to_strip = config.DATASET.VAL_DEPTH_PATH_PREFIX_TO_STRIP
        ...
        self.test_image_root = config.DATASET.TEST_IMAGE_ROOT
        self.test_depth_root = config.DATASET.TEST_DEPTH_ROOT
        self.test_image_path_prefix_to_strip = config.DATASET.TEST_IMAGE_PATH_PREFIX_TO_STRIP
        self.test_depth_path_prefix_to_strip = config.DATASET.TEST_DEPTH_PATH_PREFIX_TO_STRIP
    ...
    def setup(self, stage=None):
        ...
        try:
            ...
            self.world_size = 1
            self.rank = 0
            logger.warning(str(e) + " (set world_size=1 and rank=0)")
        ...
        if stage == 'fit':
            self.train_dataset = self._setup_dataset(
                ...
                image_root=self.train_image_root,
                depth_root=self.train_depth_root,
                image_path_prefix_to_strip=self.train_image_path_prefix_to_strip,
                depth_path_prefix_to_strip=self.train_depth_path_prefix_to_strip,
                mode='train',
            ...
            if isinstance(self.val_list_path, (list, tuple)):
                ...
                for npz_list, npz_root in zip(self.val_list_path, self.val_npz_root):
                    self.val_dataset.append(self._setup_dataset(
                        ...
                        depth_root=self.val_depth_root,
                        image_path_prefix_to_strip=self.val_image_path_prefix_to_strip,
                        depth_path_prefix_to_strip=self.val_depth_path_prefix_to_strip,
                        mode='val',
            ...
            self.test_dataset = self._setup_dataset(
                ...
                image_root=self.test_image_root,
                depth_root=self.test_depth_root,
                image_path_prefix_to_strip=self.test_image_path_prefix_to_strip,
                depth_path_prefix_to_strip=self.test_depth_path_prefix_to_strip,
                mode='test',
                min_overlap_score=self.min_overlap_score_test,
    ...
    def _setup_dataset(self,
        ...
        return dataset_builder(data_root, local_npz_names, split_npz_root, intri_path,
                                ...
                                image_path_prefix_to_strip=image_path_prefix_to_strip,
                                depth_path_prefix_to_strip=depth_path_prefix_to_strip,
