...
# NumPy 2.x compatibility for imgaug/albumentations expecting `np.sctypes`
if not hasattr(np, "sctypes"):
    try:
        ...
        # Best-effort shim: if this fails, fall back to empty mapping
        np.sctypes = {"float": [], "int": [], "uint": [], "complex": [], "others": []}
